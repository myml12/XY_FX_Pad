...
void XYPad::paint (juce::Graphics& g)
{
    ...
    juce::ColourGradient gradient (juce::Colour (0xff101214), bounds.getX(), bounds.getBottom(),
                                   juce::Colour (0xff1a1d20), bounds.getRight(), bounds.getY(), false);
    gradient.addColour (0.50, juce::Colour (0xff14171a));
    g.setGradientFill (gradient);
    g.fillRoundedRectangle (bounds, 14.0f);

    g.setColour (juce::Colour (0xff08090a).withAlpha (0.58f));
    ...
    g.setColour (juce::Colour (0xffc6ef73).withAlpha (pointerDown ? 0.20f : 0.07f));
    g.fillEllipse (centreX - 24.0f, centreY - 24.0f, 48.0f, 48.0f);
    g.setColour (juce::Colour (0xffd9f7a0).withAlpha (pointerDown ? 0.98f : 0.58f));
    g.fillEllipse (centreX - 10.0f, centreY - 10.0f, 20.0f, 20.0f);
    g.setColour (juce::Colour (0xff0b0d0e).withAlpha (0.75f));
